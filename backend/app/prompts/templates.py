...
8. **action_items**：给出 2-3 条具体的、可执行的行动建议，帮助读者深入理解或应用论文成果
9. **knowledge_links**：使用 Obsidian 双向链接格式 `[[概念名]]`，列出 2-5 个相关知识概念
10. **tier**：根据论文深度和创新性评级，A 为深度干货，B 为实用向导，C 为一般参考
